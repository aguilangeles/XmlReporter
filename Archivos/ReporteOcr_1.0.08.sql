...
CREATE TABLE `volumen` (
  ...
  `cantidad_idcs` int(11) DEFAULT NULL COMMENT 'Fecha reporte: dato sobre el momento en que se realizo el reporte ',
  `fecha_reporte` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `volumen` (`volumen`),
...
CREATE TABLE `idc` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `nombre_idc` (`nombre_idc`),
...
-- Dump completed on 2013-11-20 13:01:21
