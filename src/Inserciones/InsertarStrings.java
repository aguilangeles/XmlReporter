...
public class InsertarStrings {
    ...
    public String osn_crt() {
        ...
        c2ContenidoOSN c2 = (c2ContenidoOSN) v.getCrt_sedes().getC2().getObjetoC2();
    ...
    public String caratulas() {
        ...
        switch (idSede) {
            case 1:
                ...
                ce = c1g.getId();
                c2ContenidoGND cgnd = (c2ContenidoGND) c.getC2().getObjetoC2();
                // System.out.println(cgnd);
                ce2 = cgnd.toString();
                break;
            case 2:
                c2ContenidoOSN c2osn = (c2ContenidoOSN) c.getC2().getObjetoC2();
