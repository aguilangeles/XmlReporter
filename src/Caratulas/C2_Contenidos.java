...
public class C2_Contenidos {
    ...
    public C2_Contenidos(String nombre, MapeosC mapeoC1, ReporteXMlCaratula reporteCaratula) {
        this.nombre = nombre;
    ...
    private c2ContenidoOSN osnC2() {
        String idImagen = "";
        List<String> lista = mapeoC1.getListaValorC2();
        reporteCaratula.getEstadoDeC2(lista);
        List<String> caratulasC2 = reporteCaratula.getListaValorC2();
